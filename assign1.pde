...
void draw() {
  ...
  if (button) {
    if (!rolling){
      ...
      int pt0 = machine.getSlotScore(slotA);
      int pt1 = machine.getSlotScore(slotB);
      int pt2 = machine.getSlotScore(slotC);
      // -------------------------------------------------
    }
    machine.roll();
    textSize(19);
    ...
    if (rolling){
      ...
      // -------------------------------------------------
      // put your code inside here
      totalScore= totalScore + pt0 +pt1 +pt2;
      println("1:" + pt0 + "2:" + pt1 + "3:" +
